...
! WHILE STATEMENT...
	...
	mov	"\0\0WH",r10
_Label_1209:
!   if numFramesNeeded <= numberFreeFrames then goto _Label_1211		(int)
	load	[r14+16],r1
	load	[r14+8],r2
	load	[r2+16],r2
	cmp	r1,r2
...
! ASSIGNMENT STATEMENT...
	...
	mov	"\0\0AS",r10
!   _temp_1249 = frameAddr - 1048576		(int)
	load	[r14+-68],r1
	set	1048576,r2
	sub	r1,r2,r1
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-40]
!   bitNumber = _temp_1249 div 8192		(int)
	load	[r14+-40],r1
	mov	8192,r2
	cmp	r2,0
...
!   Data Move: _temp_1251 = *_temp_1252  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-32]
!   numberFreeFrames = numberFreeFrames + _temp_1251		(int)
	load	[r14+8],r1
	load	[r1+16],r1
	load	[r14+-32],r2
	add	r1,r2,r1
...
!   if intIsZero (aPageTable) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   _temp_1253 = aPageTable + 4
	load	[r14+12],r1
	add	r1,4,r1
	store	r1,[r14+-24]
!   Data Move: *_temp_1253 = 0  (sizeInBytes=4)
	mov	0,r1
	load	[r14+-24],r2
	store	r1,[r2]
! SEND STATEMENT...
...
!   Next value...
	...
	store	r1,[r14+-16]
_Label_1282:
!   Data Move: *_temp_1280 = 3  (sizeInBytes=4)
	mov	3,r1
	load	[r14+-20],r2
	store	r1,[r2]
!   _temp_1280 = _temp_1280 + 4
...
!   _temp_1281 = _temp_1281 + -1
	...
	add	r1,-1,r1
	store	r1,[r14+-16]
!   if intNotZero (_temp_1281) then goto _Label_1282
	load	[r14+-16],r1
	cmp	r1,r0
	bne	_Label_1282
!   Initialize the array size...
...
!   make sure array has size 20
	...
	bvs	_runtimeErrorOverflow
	bne	_runtimeErrorWrongArraySize
!   Data Move: *_temp_1278 = *_temp_1283  (sizeInBytes=84)
	load	[r14+-12],r5
	load	[r14+-108],r4
	mov	21,r3
_Label_1801:
...
!   _temp_1297 = 0		(4 bytes)
	...
	store	r1,[r14+-156]
!   Calculate and save the FOR-LOOP ending value
!   _temp_1298 = numberOfPages - 1		(int)
	load	[r14+8],r1
	load	[r1+4],r1
	mov	1,r2
	sub	r1,r2,r1
...
!   Call the function
	...
	call	print
! CALL STATEMENT...
!   _temp_1305 = &pageTable
	load	[r14+8],r1
	add	r1,8,r1
	store	r1,[r14+-124]
!   Move address of _temp_1305 [i ] into _temp_1306
!     make sure index expr is >= 0
	load	[r14+-168],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-120]
!   Data Move: _temp_1304 = *_temp_1306  (sizeInBytes=4)
	load	[r14+-120],r1
	load	[r1],r1
	store	r1,[r14+-128]
...
!   Send message ExtractUndefinedBits
	...
	add	r2,16,r2
	call	r2
!   Retrieve Result: targetName=_temp_1315  sizeInBytes=4
	load	[r15],r1
	store	r1,[r14+-92]
!   if intIsZero (_temp_1315) then goto _Label_1314
	load	[r14+-92],r1
	cmp	r1,r0
	be	_Label_1314
!	jmp	_Label_1313
...
!   Send message ExtractUndefinedBits
	...
	add	r2,16,r2
	call	r2
!   Retrieve Result: targetName=_temp_1317  sizeInBytes=4
	load	[r15],r1
	store	r1,[r14+-84]
...
!   Data Move: _temp_1392 = *_temp_1394  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-20]
!   _temp_1391 = _temp_1392 AND -8192		(int)
	load	[r14+-20],r1
	mov	-8192,r2
	and	r1,r2,r1
	store	r1,[r14+-24]
!   ReturnResult: _temp_1391  (sizeInBytes=4)
	load	[r14+-24],r1
	store	r1,[r14+8]
	add	r15,20,r15
	pop	r13
...
! RETURN STATEMENT...
	...
	mov	"\0\0RE",r10
!   _temp_1404 = &pageTable
	load	[r14+8],r1
	add	r1,8,r1
	store	r1,[r14+-16]
!   Move address of _temp_1404 [entry ] into _temp_1405
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-12]
!   Data Move: _temp_1403 = *_temp_1405  (sizeInBytes=4)
	load	[r14+-12],r1
	load	[r1],r1
	store	r1,[r14+-20]
!   _temp_1402 = _temp_1403 AND 8176		(int)
	load	[r14+-20],r1
	mov	8176,r2
	and	r1,r2,r1
	store	r1,[r14+-24]
!   ReturnResult: _temp_1402  (sizeInBytes=4)
	load	[r14+-24],r1
	store	r1,[r14+8]
	add	r15,20,r15
	pop	r13
...
!   Data Move: _temp_1417 = *_temp_1419  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-20]
!   _temp_1416 = _temp_1417 AND 8191		(int)
	load	[r14+-20],r1
	mov	8191,r2
	and	r1,r2,r1
	store	r1,[r14+-24]
!   _temp_1415 = _temp_1416 OR frameAddr		(int)
	load	[r14+-24],r1
	load	[r14+16],r2
	or	r1,r2,r1
	store	r1,[r14+-28]
...
!   Data Move: _temp_1433 = *_temp_1435  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-24]
!   _temp_1432 = _temp_1433 AND 8		(int)
	load	[r14+-24],r1
	mov	8,r2
	and	r1,r2,r1
	store	r1,[r14+-28]
!   if intIsZero (_temp_1432) then goto _Label_1436
	load	[r14+-28],r1
	cmp	r1,r0
	be	_Label_1436
!   _temp_1431 = 1		(1 byte)
...
!   _temp_1431 = 0		(1 byte)
	...
	storeb	r1,[r14+-9]
_Label_1437:
!   ReturnResult: _temp_1431  (sizeInBytes=1)
	loadb	[r14+-9],r1
	storeb	r1,[r14+8]
	add	r15,24,r15
	pop	r13
...
!   Data Move: _temp_1448 = *_temp_1450  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-24]
!   _temp_1447 = _temp_1448 AND 4		(int)
	load	[r14+-24],r1
	mov	4,r2
	and	r1,r2,r1
	store	r1,[r14+-28]
!   if intIsZero (_temp_1447) then goto _Label_1451
	load	[r14+-28],r1
	cmp	r1,r0
	be	_Label_1451
!   _temp_1446 = 1		(1 byte)
...
!   _temp_1446 = 0		(1 byte)
	...
	storeb	r1,[r14+-9]
_Label_1452:
!   ReturnResult: _temp_1446  (sizeInBytes=1)
	loadb	[r14+-9],r1
	storeb	r1,[r14+8]
	add	r15,24,r15
	pop	r13
...
!   Data Move: _temp_1463 = *_temp_1465  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-24]
!   _temp_1462 = _temp_1463 AND 2		(int)
	load	[r14+-24],r1
	mov	2,r2
	and	r1,r2,r1
	store	r1,[r14+-28]
!   if intIsZero (_temp_1462) then goto _Label_1466
	load	[r14+-28],r1
	cmp	r1,r0
	be	_Label_1466
!   _temp_1461 = 1		(1 byte)
...
!   _temp_1461 = 0		(1 byte)
	...
	storeb	r1,[r14+-9]
_Label_1467:
!   ReturnResult: _temp_1461  (sizeInBytes=1)
	loadb	[r14+-9],r1
	storeb	r1,[r14+8]
	add	r15,24,r15
	pop	r13
...
!   Data Move: _temp_1478 = *_temp_1480  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-24]
!   _temp_1477 = _temp_1478 AND 1		(int)
	load	[r14+-24],r1
	mov	1,r2
	and	r1,r2,r1
	store	r1,[r14+-28]
!   if intIsZero (_temp_1477) then goto _Label_1481
	load	[r14+-28],r1
	cmp	r1,r0
	be	_Label_1481
!   _temp_1476 = 1		(1 byte)
...
!   _temp_1476 = 0		(1 byte)
	...
	storeb	r1,[r14+-9]
_Label_1482:
!   ReturnResult: _temp_1476  (sizeInBytes=1)
	loadb	[r14+-9],r1
	storeb	r1,[r14+8]
	add	r15,24,r15
	pop	r13
...
!   Data Move: _temp_1494 = *_temp_1496  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-20]
!   _temp_1493 = _temp_1494 OR 8		(int)
	load	[r14+-20],r1
	mov	8,r2
	or	r1,r2,r1
	store	r1,[r14+-24]
!   Data Move: *_temp_1492 = _temp_1493  (sizeInBytes=4)
	load	[r14+-24],r1
	load	[r14+-28],r2
	store	r1,[r2]
! RETURN STATEMENT...
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-12]
!   Data Move: _temp_1509 = *_temp_1511  (sizeInBytes=4)
	load	[r14+-12],r1
	load	[r1],r1
	store	r1,[r14+-20]
!   _temp_1508 = _temp_1509 OR 4		(int)
	load	[r14+-20],r1
	mov	4,r2
	or	r1,r2,r1
	store	r1,[r14+-24]
...
!   Data Move: _temp_1524 = *_temp_1526  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-20]
!   _temp_1523 = _temp_1524 OR 2		(int)
	load	[r14+-20],r1
	mov	2,r2
	or	r1,r2,r1
	store	r1,[r14+-24]
...
!   Data Move: _temp_1539 = *_temp_1541  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-20]
!   _temp_1538 = _temp_1539 OR 1		(int)
	load	[r14+-20],r1
	mov	1,r2
	or	r1,r2,r1
	store	r1,[r14+-24]
!   Data Move: *_temp_1537 = _temp_1538  (sizeInBytes=4)
	load	[r14+-24],r1
	load	[r14+-28],r2
	store	r1,[r2]
! RETURN STATEMENT...
...
!   Data Move: _temp_1554 = *_temp_1556  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-20]
!   _temp_1553 = _temp_1554 AND -9		(int)
	load	[r14+-20],r1
	mov	-9,r2
	and	r1,r2,r1
	store	r1,[r14+-24]
!   Data Move: *_temp_1552 = _temp_1553  (sizeInBytes=4)
	load	[r14+-24],r1
	load	[r14+-28],r2
	store	r1,[r2]
! RETURN STATEMENT...
...
!   Data Move: _temp_1569 = *_temp_1571  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-20]
!   _temp_1568 = _temp_1569 AND -5		(int)
	load	[r14+-20],r1
	mov	-5,r2
	and	r1,r2,r1
	store	r1,[r14+-24]
...
!   Data Move: _temp_1584 = *_temp_1586  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-20]
!   _temp_1583 = _temp_1584 AND -3		(int)
	load	[r14+-20],r1
	mov	-3,r2
	and	r1,r2,r1
	store	r1,[r14+-24]
...
!   Data Move: _temp_1599 = *_temp_1601  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-20]
!   _temp_1598 = _temp_1599 AND -2		(int)
	load	[r14+-20],r1
	mov	-2,r2
	and	r1,r2,r1
	store	r1,[r14+-24]
...
!   _temp_1612 = &pageTable
	...
	add	r1,8,r1
	store	r1,[r14+-20]
!   Move address of _temp_1612 [0 ] into _temp_1613
!     make sure index expr is >= 0
	mov	0,r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-16]
!   _temp_1611 = _temp_1613		(4 bytes)
	load	[r14+-16],r1
	store	r1,[r14+-24]
!   _temp_1614 = numberOfPages * 4		(int)
	load	[r14+8],r1
	load	[r1+4],r1
	mov	4,r2
	mul	r1,r2,r1
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if intIsZero (numBytes) then goto _Label_1621
	load	[r14+20],r1
	cmp	r1,r0
	be	_Label_1621
	jmp	_Label_1622
...
! IF STATEMENT...
	mov	1317,r13		! source line 1317
	mov	"\0\0IF",r10
!   if numBytes >= 0 then goto _Label_1625		(int)
	load	[r14+20],r1
	mov	0,r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if virtPage < numberOfPages then goto _Label_1630		(int)
	load	[r14+-40],r1
	load	[r14+8],r2
	load	[r2+4],r2
	cmp	r1,r2
...
!   Send message ExtractFrameAddr
	...
	add	r2,12,r2
	call	r2
!   Retrieve Result: targetName=_temp_1637  sizeInBytes=4
	load	[r15],r1
	store	r1,[r14+-20]
!   fromAddr = _temp_1637 + offset		(int)
	load	[r14+-20],r1
	load	[r14+-44],r2
	add	r1,r2,r1
	bvs	_runtimeErrorOverflow
...
! WHILE STATEMENT...
	...
	mov	"\0\0WH",r10
_Label_1639:
!   if offset >= 8192 then goto _Label_1641		(int)
	load	[r14+-44],r1
	mov	8192,r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
!   if intIsZero (fromAddr) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   Data Move: _temp_1642 = *fromAddr  (sizeInBytes=1)
	load	[r14+-48],r1
	loadb	[r1],r1
	storeb	r1,[r14+-9]
!   Data Move: *kernelAddr = _temp_1642  (sizeInBytes=1)
	loadb	[r14+-9],r1
	load	[r14+12],r2
	storeb	r1,[r2]
! ASSIGNMENT STATEMENT...
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if copiedSoFar != numBytes then goto _Label_1644		(int)
	load	[r14+-36],r1
	load	[r14+20],r2
	cmp	r1,r2
	bne	_Label_1644
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if intIsZero (numBytes) then goto _Label_1661
	load	[r14+20],r1
	cmp	r1,r0
	be	_Label_1661
	jmp	_Label_1662
...
! IF STATEMENT...
	mov	1367,r13		! source line 1367
	mov	"\0\0IF",r10
!   if numBytes >= 0 then goto _Label_1665		(int)
	load	[r14+20],r1
	mov	0,r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if virtPage < numberOfPages then goto _Label_1672		(int)
	load	[r14+-36],r1
	load	[r14+8],r2
	load	[r2+4],r2
	cmp	r1,r2
...
!   Send message IsValid
	...
	add	r2,36,r2
	call	r2
!   Retrieve Result: targetName=_temp_1673  sizeInBytes=1
	loadb	[r15],r1
	storeb	r1,[r14+-11]
!   if _temp_1673 then goto _Label_1671 else goto _Label_1669
	loadb	[r14+-11],r1
	cmp	r1,0
	be	_Label_1669
	jmp	_Label_1671
...
!   Send message IsWritable
	...
	add	r2,32,r2
	call	r2
!   Retrieve Result: targetName=_temp_1675  sizeInBytes=1
	loadb	[r15],r1
	storeb	r1,[r14+-10]
!   if _temp_1675 then goto _Label_1670 else goto _Label_1669
	loadb	[r14+-10],r1
	cmp	r1,0
	be	_Label_1669
	jmp	_Label_1670
...
!   Retrieve Result: targetName=_temp_1677  sizeInBytes=4
	load	[r15],r1
	store	r1,[r14+-20]
!   destAddr = _temp_1677 + offset		(int)
	load	[r14+-20],r1
	load	[r14+-40],r2
	add	r1,r2,r1
	bvs	_runtimeErrorOverflow
...
! WHILE STATEMENT...
	...
	mov	"\0\0WH",r10
_Label_1679:
!   if offset >= 8192 then goto _Label_1681		(int)
	load	[r14+-40],r1
	mov	8192,r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
!   if intIsZero (kernelAddr) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   Data Move: _temp_1682 = *kernelAddr  (sizeInBytes=1)
	load	[r14+16],r1
	loadb	[r1],r1
	storeb	r1,[r14+-9]
!   Data Move: *destAddr = _temp_1682  (sizeInBytes=1)
	loadb	[r14+-9],r1
	load	[r14+-44],r2
	storeb	r1,[r2]
! ASSIGNMENT STATEMENT...
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if copiedSoFar != numBytes then goto _Label_1684		(int)
	load	[r14+-32],r1
	load	[r14+20],r2
	cmp	r1,r2
	bne	_Label_1684
...
!   Retrieve Result: targetName=_temp_1703  sizeInBytes=4
	load	[r15],r1
	store	r1,[r14+-40]
!   if _temp_1703 >= 4 then goto _Label_1702		(int)
	load	[r14+-40],r1
	mov	4,r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if sourceSize <= maxSize then goto _Label_1707		(int)
	load	[r14+-44],r1
	load	[r14+20],r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
! RETURN STATEMENT...
	...
	mov	1433,r13		! source line 1433
	mov	"\0\0SE",r10
!   _temp_1710 = kernelAddr		(4 bytes)
	load	[r14+12],r1
	store	r1,[r14+-20]
!   _temp_1709 = _temp_1710 + 4		(int)
	load	[r14+-20],r1
	mov	4,r2
	add	r1,r2,r1
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-24]
!   _temp_1711 = virtAddr + 4		(int)
	load	[r14+16],r1
	mov	4,r2
	add	r1,r2,r1
	bvs	_runtimeErrorOverflow
...
!   Prepare Argument: offset=12  value=_temp_1709  sizeInBytes=4
	load	[r14+-24],r1
	store	r1,[r15+4]
!   Prepare Argument: offset=16  value=_temp_1711  sizeInBytes=4
	load	[r14+-16],r1
	store	r1,[r15+8]
...
!   Send message CopyBytesFromVirtual
	...
	add	r2,76,r2
	call	r2
!   Retrieve Result: targetName=_temp_1708  sizeInBytes=4
	load	[r15],r1
	store	r1,[r14+-28]
