...
-----------------------------  ProducerConsumer  ---------------------------------
  ...
  var
    ...
    lock1: Mutex = new Mutex	-- The Mutex for producer
    producer: Semaphore = new Semaphore	-- The semaphore for the producers
    consumer: Semaphore = new Semaphore -- The semaphore for the consumers
