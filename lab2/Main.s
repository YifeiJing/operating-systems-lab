...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_298 = &_Global_lock1
	set	_Global_lock1,r1
	store	r1,[r14+-216]
!   Send message Init
	load	[r14+-216],r1
	load	[r1],r2
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_299 = &_Global_producer
	set	_Global_producer,r1
	store	r1,[r14+-212]
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_300 = &_Global_consumer
	set	_Global_consumer,r1
	store	r1,[r14+-208]
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_305 = _function_33_Consumer
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_311 = _function_33_Consumer
	set	_function_33_Consumer,r1
	store	r1,[r14+-164]
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_317 = _function_33_Consumer
	set	_function_33_Consumer,r1
	store	r1,[r14+-140]
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_323 = _function_34_Producer
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_329 = _function_34_Producer
	set	_function_34_Producer,r1
	store	r1,[r14+-92]
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_335 = _function_34_Producer
	set	_function_34_Producer,r1
	store	r1,[r14+-68]
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_341 = _function_34_Producer
	set	_function_34_Producer,r1
	store	r1,[r14+-44]
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_347 = _function_34_Producer
	set	_function_34_Producer,r1
	store	r1,[r14+-20]
...
! ASSIGNMENT STATEMENT...
	...
	mov	"\0\0AS",r10
!   _temp_413 = &_Global_buffer
	set	_Global_buffer,r1
	store	r1,[r14+-32]
!   Move address of _temp_413 [_Global_bufferNextIn ] into _temp_414
!     make sure index expr is >= 0
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-28]
!   Data Move: *_temp_414 = c  (sizeInBytes=1)
	loadb	[r14+-9],r1
	load	[r14+-28],r2
	storeb	r1,[r2]
! ASSIGNMENT STATEMENT...
	...
	mov	"\0\0AS",r10
!   _temp_415 = _Global_bufferNextIn + 1		(int)
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-24]
!   _Global_bufferNextIn = _temp_415 rem 5		(int)
	load	[r14+-24],r1
	mov	5,r2
	cmp	r2,0
...
! ASSIGNMENT STATEMENT...
	...
	mov	"\0\0AS",r10
!   _temp_438 = &_Global_buffer
	set	_Global_buffer,r1
	store	r1,[r14+-32]
!   Move address of _temp_438 [_Global_bufferNextOut ] into _temp_439
!     make sure index expr is >= 0
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-28]
!   Data Move: c = *_temp_439  (sizeInBytes=1)
	load	[r14+-28],r1
	loadb	[r1],r1
	storeb	r1,[r14+-9]
! ASSIGNMENT STATEMENT...
	...
	mov	"\0\0AS",r10
!   _temp_440 = _Global_bufferNextOut + 1		(int)
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-24]
!   _Global_bufferNextOut = _temp_440 rem 5		(int)
	load	[r14+-24],r1
	mov	5,r2
	cmp	r2,0
	be	_runtimeErrorZeroDivide
...
!   _temp_460 = 1		(4 bytes)
	...
	store	r1,[r14+-40]
!   Calculate and save the FOR-LOOP ending value
!   _temp_461 = _Global_bufferSize		(4 bytes)
	set	_Global_bufferSize,r1
	load	[r1],r1
	store	r1,[r14+-36]
!   Initialize FOR-LOOP index variable
...
_Label_457:
	...
	mov	"\0\0FB",r10
! CALL STATEMENT...
!   _temp_463 = &_Global_buffer
	set	_Global_buffer,r1
	store	r1,[r14+-32]
!   Move address of _temp_463 [j ] into _temp_464
!     make sure index expr is >= 0
	load	[r14+-60],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-28]
!   Data Move: _temp_462 = *_temp_464  (sizeInBytes=1)
	load	[r14+-28],r1
	loadb	[r1],r1
	storeb	r1,[r14+-9]
!   Prepare Argument: offset=8  value=_temp_462  sizeInBytes=1
	loadb	[r14+-9],r1
	storeb	r1,[r15+0]
!   Call the function
...
!   _temp_470 = 1		(4 bytes)
	...
	store	r1,[r14+-20]
!   Calculate and save the FOR-LOOP ending value
!   _temp_471 = 5 - _Global_bufferSize		(int)
	mov	5,r1
	set	_Global_bufferSize,r2
	load	[r2],r2
	sub	r1,r2,r1
