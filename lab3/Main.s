...
!   Send message CheckFork
	...
	add	r2,20,r2
	call	r2
!   if result==true then goto _Label_136 else goto _Label_137
	loadb	[r15],r1
	cmp	r1,0
	be	_Label_137
	jmp	_Label_136
...
!   _temp_143 = &status
	...
	add	r1,4,r1
	store	r1,[r14+-32]
!   Move address of _temp_143 [p ] into _temp_144
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   _temp_164 = &status
	...
	add	r1,4,r1
	store	r1,[r14+-32]
!   Move address of _temp_164 [p ] into _temp_165
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   _temp_185 = 4		(4 bytes)
	...
	store	r1,[r14+-36]
!   Initialize FOR-LOOP index variable
!   Data Move: p = _temp_184  (sizeInBytes=4)
	load	[r14+-40],r1
	store	r1,[r14+-44]
_Label_180:
!   Perform the FOR-LOOP termination test
!   if p > _temp_185 then goto _Label_183		
	load	[r14+-44],r1
	load	[r14+-36],r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
!   _temp_192 = &status
	...
	add	r1,4,r1
	store	r1,[r14+-28]
!   Move address of _temp_192 [p ] into _temp_193
!     make sure index expr is >= 0
	load	[r14+-44],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   _temp_213 = _temp_214 rem 5		(int)
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-40]
!   Move address of _temp_212 [_temp_213 ] into _temp_215
!     make sure index expr is >= 0
	load	[r14+-40],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-32]
!   Data Move: _temp_211 = *_temp_215  (sizeInBytes=4)
	load	[r14+-32],r1
	load	[r1],r1
	store	r1,[r14+-48]
!   if _temp_211 == 2 then goto _Label_209		(int)
	load	[r14+-48],r1
	mov	2,r2
	cmp	r1,r2
	be	_Label_209
...
!   _temp_218 = _temp_219 rem 5		(int)
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-20]
!   Move address of _temp_217 [_temp_218 ] into _temp_220
!     make sure index expr is >= 0
	load	[r14+-20],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-12]
!   Data Move: _temp_216 = *_temp_220  (sizeInBytes=4)
	load	[r14+-12],r1
	load	[r1],r1
	store	r1,[r14+-28]
!   if _temp_216 == 2 then goto _Label_209		(int)
	load	[r14+-28],r1
	mov	2,r2
	cmp	r1,r2
	be	_Label_209
